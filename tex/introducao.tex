...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{tex/IPCC_AR6_WGI_Figure_4_2.png}
...
A temperatura do ar representa o indicador mais direto do aquecimento global, refletindo o balanço energético da atmosfera. Variações na temperatura média influenciam padrões de evapotranspiração, demanda energética, circulação atmosférica e a distribuição espacial de espécies sensíveis ao clima. Eventos extremos de temperatura, como ondas de calor e frio, têm se tornado mais frequentes, com impactos diretos sobre a saúde pública e os sistemas urbanos.

Estudos recentes documentam tendências de aquecimento em diversas regiões do Brasil. \cite{abreu2019} investigaram os principais fatores que controlam a temperatura do ar na região Sudeste, identificando a influência da zonalidade, continentalidade e altitude, além da cobertura da terra representada pelo NDVI e da cobertura de nuvens. Utilizando 26 anos de dados de 52 estações meteorológicas, os autores observaram um gradiente térmico noroeste--sudeste no estado de São Paulo, com variações de aproximadamente 3~°C na temperatura máxima média e 2~°C na temperatura mínima média.

No contexto urbano, o fenômeno das ilhas de calor urbanas (ICU) intensifica as temperaturas locais, sobretudo em grandes centros urbanos. Campelo (2024) identificou em seu trabalho de dissertação um aumento da intensidade da ilha de calor urbana de superfície na região metropolitana de São Paulo da ordem de 0,13~°C por década, com intensidades superiores a 1,6~°C durante o dia e 2,6~°C durante a noite.
...
\cite{wang2008} apresentam uma revisão detalhada das metodologias para a estimativa da irradiância solar incidente na superfície (Surface Solar Irradiance – SSI) a partir de observações por satélite, abordando o desenvolvimento histórico dessas técnicas, assim como descrito pela Figura \ref{fig:evolucao} que menciona os métodos operacionais atualmente empregados, os procedimentos de validação e suas principais aplicações em escalas regional e global. Os autores demonstram que as primeiras tentativas de estimativa da irradiância solar por sensoriamento remoto remontam à década de 1960 e que, ao longo das décadas seguintes, o avanço dos sensores orbitais e dos modelos de transferência radiativa consolidou os produtos de SSI como a principal ferramenta para o mapeamento da variabilidade espaço-temporal da radiação solar na superfície terrestre.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{evolucao.png}
    \caption[Evolução histórica das estimativas de irradiância solar por satélite.]
{Linha do tempo do desenvolvimento das estimativas de irradiância solar de superfície a partir de observações por satélite, destacando marcos históricos, avanços metodológicos e o surgimento de produtos operacionais globais. Extraído de \cite{wang2008}.}

    \label{fig:evolucao}
\end{figure}

No contexto operacional, \cite{laszlo2020} descrevem o produto Enterprise Shortwave Radiation Budget da série GOES, que fornece estimativas contínuas da radiação solar de onda curta em alta resolução temporal e espacial. Esses produtos representam uma ferramenta essencial para estudos regionais de variabilidade e tendências climáticas, permitindo a análise consistente da radiação solar incidente na superfície em diferentes escalas temporais e espaciais.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{tex/G19_ABI_20250621_1700_SWRadiation.jpg}
\caption[Distribuição global da radiação solar e seus componentes.]
{Distribuição global da radiação fotossinteticamente ativa, da radiação solar de onda curta incidente na superfície e da radiação solar refletida no topo da atmosfera, conforme estimativas derivadas do sistema GOES. Extraído de: \url{https://www.star.nesdis.noaa.gov/goesr/product_sw.php}}
\label{fig:radiation_components}
\end{figure}

A distribuição espacial da radiação solar e de seus diferentes componentes pode ser analisada de forma integrada a partir de observações por satélite, possibilitando a caracterização simultânea da energia disponível na superfície, da fração refletida no topo da atmosfera e dos fluxos modulados pela cobertura de nuvens e pela presença de aerossóis. A Figura~\ref{fig:radiation_components} ilustra esses padrões em escala global, evidenciando a capacidade dos produtos derivados de satélites geoestacionários em representar a variabilidade espacial da radiação solar e sua relação com os processos atmosféricos.
...
{(a) Distribuição mensal da precipitação observada durante os períodos chuvosos de 2013--2014 e 2014--2015, em comparação com a climatologia de 1981--2010. (b) Precipitação acumulada anual, mostrando que o ano hidrológico de 2014 apresentou valores próximos aos limites inferiores da variabilidade climatológica. Extraído de \cite{coelho2016}}
...
No que se refere à radiação solar incidente na superfície, produtos derivados de sensoriamento remoto têm sido amplamente empregados para complementar redes observacionais com cobertura espacial limitada. Conjuntos de dados como o CHIRPS, no caso da precipitação, e produtos de irradiância solar derivados de satélites geoestacionários e orbitais polares têm permitido análises consistentes da variabilidade espacial e temporal das variáveis climáticas em diferentes escalass \citep{funk2015}. No entanto, ainda são limitados os estudos que integram de forma sistemática dados observacionais e produtos de satélite para a análise conjunta de temperatura, precipitação e radiação solar em diferentes regiões do Brasil.
...
A seleção dos estados de São Paulo e Rio Grande do Norte fundamenta-se na representatividade de distintos regimes climáticos brasileiros, bem como nas diferenças de uso e cobertura da terra associadas a contextos socioambientais contrastantes. A análise comparativa entre essas regiões permite investigar a variabilidade climática sob diferentes condições atmosféricas, hidrológicas e de superfície.

O estado de São Paulo apresenta clima predominantemente subtropical, elevada heterogeneidade de usos do solo e uma das redes mais densas de estações meteorológicas do país, possibilitando análises robustas e avaliações consistentes de produtos de satélite e reanálises. Estudos indicam que a cobertura da terra exerce influência significativa na modulação da temperatura do ar, evidenciando o papel da vegetação na regulação térmica regional \citep{abreu2019}.

O estado do Rio Grande do Norte caracteriza-se por clima semiárido a tropical, elevada variabilidade pluviométrica e forte dependência de recursos hídricos limitados, sendo particularmente vulnerável a eventos extremos de secaa \citep{marengo2017}. A comparação entre esses estados permite identificar padrões de mudanças climáticas em contextos regionais distintos e ampliar a compreensão dos processos associados à variabilidade climática no Brasil.
...
\begin{itemize}
\item Caracterizar os padrões de precipitação, temperatura e radiação solar utilizando dados do INMET, ANA, CHIRPS, GOES e ERA5-Land;
