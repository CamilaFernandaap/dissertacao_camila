...
\item Caracterizar os padrões de precipitação, temperatura e radiação solar incidente 
  em superfície utilizando dados do Instituto Nacional de Meteorologia (INMET), Agência Nacional de Águas e Saneamento Básico (ANA), Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS), Geostationary Operational Environmental Satellite (GOES), CLARA-A3 (CM SAF cLoud, Albedo and surface RAdiation dataset – Edition 3) e European ReAnalysis 5th Generation (ERA5-Land);
