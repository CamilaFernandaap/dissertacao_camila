...
\begin{table}[h!]
\centering
\caption[Descrição das classes climáticas segundo a classificação de Köppen-Geiger]{Descrição das classes climáticas segundo a classificação de Köppen-Geiger. 
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{fig/mapa_sp.png}}
